...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0xFD92,                 // Product ID: CDC RS-232 Emulation Demo
...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[17];}sd001={
sizeof(sd001),USB_DESCRIPTOR_STRING,
{'S','c','h','m','a','l','z',' ','H','a','u','s',' ','L','L','C','.'
}};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[16];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'U','B','W','3','2',' ','U','S','B',' ','S','e','r','i','a','l'}
};
