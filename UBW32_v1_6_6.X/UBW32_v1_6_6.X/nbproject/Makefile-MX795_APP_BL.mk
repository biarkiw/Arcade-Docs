...
ifeq "$(wildcard nbproject/Makefile-local-MX795_APP_BL.mk)" "nbproject/Makefile-local-MX795_APP_BL.mk"
include nbproject/Makefile-local-MX795_APP_BL.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-MX795_APP_BL.mk dist/${CND_CONF}/${IMAGE_TYPE}/UBW32_v1_6_6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/UBW32_v1_6_6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   elf32pic32mx_UBW32_BL.ld ../HIDBoot.X/dist/MX795/production/HIDBoot.X.production.hex
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	...
	@"C:/Program Files (x86)/Microchip/MPLABX/v5.35/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/v5.35/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/UBW32_v1_6_6.X.${IMAGE_TYPE}.hex ../HIDBoot.X/dist/MX795/production/HIDBoot.X.production.hex -odist/${CND_CONF}/production/UBW32_v1_6_6.X.production.unified.hex
...
.build-subprojects:
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
	cd ../HIDBoot.X && ${MAKE}  -f Makefile CONF=MX795 TYPE_IMAGE=DEBUG_RUN
else
	cd ../HIDBoot.X && ${MAKE}  -f Makefile CONF=MX795
endif


# Subprojects
.clean-subprojects:
	cd ../HIDBoot.X && rm -rf "build/MX795" "dist/MX795"

# Clean Targets
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/MX795_APP_BL
	${RM} -r dist/MX795_APP_BL
