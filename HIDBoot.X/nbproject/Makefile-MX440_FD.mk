...
ifeq "$(wildcard nbproject/Makefile-local-MX440_FD.mk)" "nbproject/Makefile-local-MX440_FD.mk"
include nbproject/Makefile-local-MX440_FD.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-MX440_FD.mk dist/${CND_CONF}/${IMAGE_TYPE}/HIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/343710134/usb_device.o: ../Microchip/USB/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/343710134/usb_device.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mno-float -DFUBARDUINO -I".." -I"../Microchip/Include" -I"../Microchip/Include/USB" -I"./" -I"../HIDBoot.X/" -I"../.." -O1 -MMD -MF "${OBJECTDIR}/_ext/343710134/usb_device.o.d" -o ${OBJECTDIR}/_ext/343710134/usb_device.o ../Microchip/USB/usb_device.c   -fno-forward-propagate
